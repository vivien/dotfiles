...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=239 ctermfg=fg gui=NONE guibg=#4a4a4a guifg=fg
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=37 ctermfg=231 gui=NONE guibg=#008b8b guifg=#f6f3e8
    CSAHi DiffChange term=bold cterm=NONE ctermbg=127 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=235 ctermfg=132 gui=NONE guibg=#242424 guifg=#8b3a62
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=#bebebe guifg=#00ffff
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=30 ctermfg=230 gui=NONE guibg=#008b8b guifg=#f6f3e8
    CSAHi DiffChange term=bold cterm=NONE ctermbg=90 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=235 ctermfg=95 gui=NONE guibg=#242424 guifg=#8b3a62
    CSAHi DiffText term=reverse cterm=bold ctermbg=196 ctermfg=fg gui=bold guibg=#ff0000 guifg=fg
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=#bebebe guifg=#00ffff
    CSAHi SpellBad term=reverse cterm=undercurl ctermbg=bg ctermfg=196 gui=undercurl guibg=bg guifg=fg guisp=#ff0000
    CSAHi SpellCap term=reverse cterm=undercurl ctermbg=bg ctermfg=21 gui=undercurl guibg=bg guifg=fg guisp=#0000ff
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=81 ctermfg=fg gui=NONE guibg=#4a4a4a guifg=fg
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=21 ctermfg=79 gui=NONE guibg=#008b8b guifg=#f6f3e8
    CSAHi DiffChange term=bold cterm=NONE ctermbg=33 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=80 ctermfg=33 gui=NONE guibg=#242424 guifg=#8b3a62
